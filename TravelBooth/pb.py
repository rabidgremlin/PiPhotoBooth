...
text_press_space = font_mid.render("PRESS SPACE TO BEGIN", True, (111, 1, 56))

text_pose = font_big.render("PREPARE FOR PHOTO CHECK", True, (0, 0, 0))
text_3 = font_super.render("3", True, (111, 1, 56))
text_2 = font_super.render("2", True, (111, 1, 56))
text_1 = font_super.render("1", True, (111, 1, 56))
text_hold = font_big.render("HOLD", True, (111, 1, 56))
